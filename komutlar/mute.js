...
const ms = require("ms");
var mutelu = "693928065922891787"; //buraya muteli rolünün id'sini koyunuz
var muteyetkisi = "693918905407897691"; // buraya mute yetkis irolünün id yazınız.
    ...
    if (!muted) {
      ...
      if (
        ...
        if (!mutezaman) {
          ...
          //ck!sustur @etiket 0 zaman 1 sebep 2
